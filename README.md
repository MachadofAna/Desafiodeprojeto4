...
##  Objetivo
   O desafio teve como objetivo a criação de uma pesquisa que funcionasse juntamente com um serviço inteligência artificial para identificar sentimentos e palavras-chave utilizando o serviço de armazenamento do Azure. As orientações dessa funcionalidade podem ser encontradas na [Documentação oficial](https://microsoftlearning.github.io/mslearn-ai-fundamentals/Instructions/Labs/11-ai-search.html)
